              ...
              <CardContent className="bg-white">
                <form className="space-y-4">
                  <div>
                    ...
                    <Input id="title" placeholder="Enter package title" className="bg-white" />
                  </div>
                  
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="days">Days</Label>
                      <Input id="days" type="number" placeholder="Number of days" className="bg-white" />
                    </div>
                    <div>
                      <Label htmlFor="nights">Nights</Label>
                      <Input id="nights" type="number" placeholder="Number of nights" className="bg-white" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea id="description" placeholder="Enter package description" className="bg-white" />
                  </div>
