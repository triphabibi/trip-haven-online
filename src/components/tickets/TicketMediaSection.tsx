  ...
  return (
    <div className="w-full min-w-0 overflow-hidden">
      <div className="space-y-2 sm:space-y-3 lg:space-y-4 w-full">
        ...
        {ticket.video_url && (
          <Card className="overflow-hidden border-0 shadow-sm w-full min-w-0">
        ...
        <div className="flex flex-wrap gap-1 sm:gap-2 px-1 w-full min-w-0">
          {ticket.is_featured && (
            <Badge className="bg-yellow-500 hover:bg-yellow-600 text-xs flex-shrink-0">Featured</Badge>
          )}
          {ticket.instant_delivery && (
            <Badge className="bg-green-500 hover:bg-green-600 text-xs flex items-center gap-1 flex-shrink-0">
          ...
          {ticket.instant_confirmation && (
            <Badge className="bg-blue-500 hover:bg-blue-600 text-xs flex items-center gap-1 flex-shrink-0">
