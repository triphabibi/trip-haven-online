...
import { Users, Package, CreditCard, TrendingUp, Settings as SettingsIcon, Ticket, Car, Menu } from 'lucide-react';
        ...
        <Card className="shadow-lg bg-white border border-gray-200">
          <Tabs defaultValue="tours" className="space-y-4">
            <TabsList className="grid w-full grid-cols-6 lg:grid-cols-13 bg-gray-100 border-b border-gray-200">
              ...
              <TabsTrigger value="menus" className="data-[state=active]:bg-cyan-500 data-[state=active]:text-white bg-white text-gray-700">Menus</TabsTrigger>
